...
import { RiUserLine, RiVideoAddLine } from "react-icons/ri";
  ...
  return (
    <div className="sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-black">
      ...
      <div className="group flex items-center">
          ...
          <button className="w-[40px] md:w-[60px] h-8 md:h-10 flex items-center justify-center boredr-l-0 border-[#303030] rounded-r-3xl bg-white/[0.1]">
            <IoIosSearch className="text-white text-xl"/>
            </button>
      </div>
      <div className="flex items-center">
        ...
        <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
            <img src="https://robohash.org/stefan-three" alt="user" />
          </div>
      </div>
    </div>
  );
